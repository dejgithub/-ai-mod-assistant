...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-16 pb-20 px-4">
      ...
      <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-ai-blue/20 rounded-full blur-[100px]" />
      <div className="absolute bottom-1/3 right-1/3 w-64 h-64 bg-ai-purple/20 rounded-full blur-[100px]" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Sign in to your moderator dashboard</p>
        </div>

        <form onSubmit={handleSubmit} className="card space-y-5">
          <div>
            <label className="block text-sm text-gray-400 mb-2">Username</label>
            <input type="text" required value={form.username} onChange={e => setForm({...form, username: e.target.value})} className="input-field" placeholder="your_username" />
          </div>
          <div>
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center space-x-2">
              <input type="checkbox" className="rounded border-white/10 bg-white/5 text-ai-blue focus:ring-ai-blue" />
              <span className="text-gray-500">Remember me</span>
            </label>
            <a href="#" className="text-ai-blue hover:text-ai-blue/80">Forgot password?</a>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link to="/register" className="text-ai-blue font-medium hover:text-ai-blue/80">
              Sign up free
            </Link>
          </p>
        </form>
